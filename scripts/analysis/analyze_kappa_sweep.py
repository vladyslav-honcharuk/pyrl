...
Usage:
    python3 scripts/analysis/analyze_kappa_sweep.py models/gambling.py
    python3 scripts/analysis/analyze_kappa_sweep.py models/gambling.py --parallel  # Run in parallel (faster)
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 scripts/analysis/analyze_kappa_sweep.py <model_file> [--parallel] [--max-parallel N]")
        print("Example: python3 scripts/analysis/analyze_kappa_sweep.py models/gambling.py")
        print("Example: python3 scripts/analysis/analyze_kappa_sweep.py models/gambling.py --parallel --max-parallel 4")
        sys.exit(1)
    ...
    print(f"\n💾 Results saved in: data/figures/{base_name}*/")
    print(f"{'='*80}\n")
