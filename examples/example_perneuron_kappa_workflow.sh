...
python3 analyze_single_model.py "$MODEL" --suffix _gaussian_kappa --kappa 0.0 --trials 5

echo ""
echo "Analyzing Uniform per-neuron kappa model..."
python3 analyze_single_model.py "$MODEL" --suffix _uniform_kappa --kappa 0.0 --trials 5

echo ""
echo "Analyzing single kappa baseline model..."
python3 analyze_single_model.py "$MODEL" --suffix _single_kappa --kappa 0.0 --trials 5
