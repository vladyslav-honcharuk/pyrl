...
Usage:
    python3 analyze_single_model.py models/gambling.py
    python3 analyze_single_model.py models/gambling.py --suffix _gaussian_kappa
    python3 analyze_single_model.py models/gambling.py --suffix pos0p5 --kappa 0.5
"""
...
Examples:
  ...
  python3 analyze_single_model.py models/gambling.py --suffix _uniform_kappa --kappa 0.0 --trials 10

  # Skip certain analysis steps
  python3 analyze_single_model.py models/gambling.py --skip-trials --skip-temporal
...
"""
    ...
    if not os.path.exists(modelfile):
        ...
        print("Example: python3 analyze_single_model.py models/gambling.py")
        sys.exit(1)
    ...
    if not os.path.exists(model_path):
        ...
        if suffix:
            print(f"  python3 do.py {modelfile} train --suffix {suffix}")
        else:
            print(f"  python3 do.py {modelfile} train")
        sys.exit(1)
    ...
    print(f"\n💾 Results saved in:")
    print(f"  Figures: work/figs/{model_name}/")
    print(f"  Data: work/data/{model_name}/")
    print(f"{'=' * 80}\n")
